...
function App() {
  ...
  const users = [
    {id:1, name: "Naiara", age:"29", profession: "Desenvolvedora"},
    {id:2, name: "Gabriela", age:"25", profession: "Professora"},
    {id:3, name: "Na", age:"27", profession: "Microbiologista"},
    {id:4, name: "Nai", age:"17", profession: "Estudante"},
  ];
